                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('suppliers.update', $supplier) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="contact_name" name="contact_name" type="text" class="mt-1 block w-full" :value="old('contact_name', $supplier->contact_name)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="suppliers_rfc" name="suppliers_rfc" type="text" class="mt-1 block w-full" :value="old('suppliers_rfc', $supplier->suppliers_rfc)" required />
